...
public final class SQLiteUtils {
    ...
    public static <T extends Model> ArrayList<T> rawQuery(Class<? extends Model> type, String sql, String[] selectionArgs) {
        Cursor cursor = Cache.openDatabase().rawQuery(sql, selectionArgs);
        ArrayList<T> entities = processCursor(type, cursor);
        cursor.close();
    ...
    @SuppressWarnings("unchecked")
    public static <T extends Model> ArrayList<T> processCursor(Class<? extends Model> type, Cursor cursor) {
