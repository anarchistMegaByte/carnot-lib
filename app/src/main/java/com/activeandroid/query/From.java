...
import com.activeandroid.OnReadSingleAsync;
...
public final class From implements Sqlable {
    ...
    /**
     * Designed by pankaj to runIn Background
     *
     * @param <T>
     * @return
     */
    public <T extends Model> void executeAsync(final OnReadAsync callback) {

        new AsyncTask<Void, Void, ArrayList<T>>() {

            @Override
            protected ArrayList<T> doInBackground(Void... params) {
                return From.this.execute();
            }

            @Override
            protected void onPostExecute(ArrayList<T> ts) {
     ...
     * @return
     */
    public <T extends Model> void executeSingleAsync(final OnReadSingleAsync callback) {

        new AsyncTask<Void, Void, T>() {

            @Override
            protected T doInBackground(Void... params) {
                return From.this.executeSingle();
            }
