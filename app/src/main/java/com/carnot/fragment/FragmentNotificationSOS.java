 ...
 */
public class FragmentNotificationSOS extends BaseFragment {

    private Button btnDismiss;

    public FragmentNotificationSOS() {
        setContentView(R.layout.fragment_notification_sos);
    }
    ...
    public void initView() {
        btnDismiss = (Button) links(R.id.btnDismiss);
    }
    ...
    public void loadData() {
        initMaps();
        btnDismiss.setText(getString(R.string.lbl_dismiss_x, "00:48"));

        timer = new CountDownTimer(1 * 60 * 1000, 1000) {
            @Override
            public void onTick(long millisUntilFinished) {
                btnDismiss.setText(getString(R.string.lbl_dismiss_x, Utility.getMinsSeconds(millisUntilFinished / 1000)));
            }
