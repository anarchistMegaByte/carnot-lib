...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.e(TAG, "onHandleIntent: Reached Intent service");
        ...
        Location location = intent.getParcelableExtra(LocationUtils.LocationConstants.LOCATION_DATA_EXTRA);

        // Make sure that the location data was really sent over through an extra. If it wasn't,
        // send an error error message and return.
        if (location == null) {
            Log.wtf(TAG, "Location not found");
            deliverResultToReceiver(LocationUtils.LocationConstants.FAILURE_RESULT, errorMessage, null);
            return;
        }
        ...
        if (addresses == null || addresses.size() == 0) {
            ...
            Log.e(TAG, "onHandleIntent: Addresses" + address );
    ...
    private void deliverResultToReceiver(int resultCode, String message, Address address) {
        try {
            ...
            bundle.putString(LocationUtils.LocationConstants.LOCATION_DATA_AREA, address.getSubLocality());

            bundle.putString(LocationUtils.LocationConstants.LOCATION_DATA_CITY, address.getLocality());
            bundle.putString(LocationUtils.LocationConstants.LOCATION_DATA_STREET, address.getAddressLine(0));
